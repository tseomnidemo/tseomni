<template>
  <div>
    ...
    <!-- 第一组对比 -->
    <el-row justify="center">
      <h2 class="category-title">Comparison Group 1</h2>
    </el-row>
    ...
    <el-row justify="center" class="audio-grid">
      ...
      <el-col :xs="4" :sm="3" :md="2" :lg="2" :xl="1">
        <div class="audio-item">
          ...
          <audio controls>
            <source src="/path/to/mixture1.wav" type="audio/wav">
          </audio>
        </div>
      </el-col>
      ...
      <el-col :xs="4" :sm="3" :md="2" :lg="2" :xl="1">
        <div class="audio-item">
          ...
          <audio controls>
            <source src="/path/to/gt1.wav" type="audio/wav">
          </audio>
        </div>
      </el-col>
      ...
      <el-col :xs="4" :sm="3" :md="2" :lg="2" :xl="1">
        <div class="audio-item">
          ...
          <audio controls>
            <source src="/path/to/audio_cue1.wav" type="audio/wav">
          </audio>
        </div>
      </el-col>
      ...
      <el-col :xs="4" :sm="3" :md="2" :lg="2" :xl="1">
        <div class="audio-item">
          ...
          <video controls width="100" height="60">
            <source src="/path/to/visual_cue1.mp4" type="video/mp4">
          </video>
        </div>
      </el-col>
